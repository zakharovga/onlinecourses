            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <c:if test="${quantityError != null}">
                        <div class = "errors">${quantityError}</div>
                    </c:if>
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tr>
                                <td><p>Teacher</p></td>
                                <td><p><a href="<c:url value='/teachers/${course.teacher.id}'></c:url>"><span>${course.teacher.firstName}</span> <span>${course.teacher.lastName}</span></a></p></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td>
                                    <c:if test="${!isEnrolled}">
                                        <form action="<c:url value='/courses/${course.id}/enrol/${studentId}'></c:url>" method="post">
                                            <input name="add" value="Enrol for this course" type="submit" class="btn btn-default">
                                        </form>
                                    </c:if>
                                </td>
                            </tr>
