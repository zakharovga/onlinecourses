...
<div class="container">
    <div class="row">
        <div class="col-md-8">
                <h1 class="page-header">Our teachers</h1>
                <table class="table table-hover">
                    <caption><span>${teacher.lastName}</span> <span>${teacher.firstName}</span></caption>
                    <tbody>
                    <tr>
                        <td><p>About Teacher</p></td>
                        <td><p>${teacher.description}</p></td>
                    </tr>
                    <tr>
                        <td><p>Teacher's subjects</p></td>
                        <td>
                            <c:forEach var="subject" items="${subjects}">
                                <p><a href="<c:url value='/subjects/${subject.code}'></c:url>">${subject.name}</a></p>
                            </c:forEach>
                        </td>
                    </tr>
                    </tbody>
