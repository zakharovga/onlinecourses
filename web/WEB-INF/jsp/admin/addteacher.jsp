        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <tbody>
                    <c:forEach var="teacher" items="${notAddedTeachers}">
                    <tr>
                        ...
                        <td>
                            <form action="<c:url value='addteacher/${teacher.id}'></c:url>" method="post">
                                <input name="add" value="Add teacher" type="submit" class="btn btn-default">
                            </form>
                        </td>
                    </tr>
                    </c:forEach>
