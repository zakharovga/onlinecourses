...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h1 class="page-header">Add subjects to teacher</h1>
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <tbody>
                    <c:forEach var="subject" items="${notAddedSubjects}">
                    <tr>
                        <td><p><c:out value="${subject.code}"></c:out></p></td>
                        <td><p><c:out value="${subject.name}"></c:out></p></td>
                        <td>
                            <form action="<c:url value='addsubject/${subject.code}'></c:url>" method="post">
                                <input name="add" value="Add subject" type="submit" class="btn btn-default">
                            </form>
                        </td>
                    </tr>
                    </c:forEach>
