...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <h2 class="sub-header">Subjects   <a href="<c:url value='/admin/subjects/create'></c:url>" class="btn btn-default" role="button">Add new subject</a></h2>
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <c:forEach var="subject" items="${subjects}">
                        <tr>
                            <td><p><c:out value="${subject.code}"></c:out></p></td>
                            <td><p><c:out value="${subject.name}"></c:out></p></td>
                            <td><p><c:out value="${subject.price}"></c:out></p></td>
                            <td>
                                <p><a href="<c:url value='/admin/subjects/create'><c:param name="c" value="${subject.code}"></c:param></c:url>"><span class="glyphicon glyphicon-pencil"></span> Edit info</a></p>
                                <p><a href="<c:url value='/admin/subjects/${subject.code}/addteacher'></c:url>"><span class="glyphicon glyphicon-plus"></span> Add teachers</a></p>
                                <p><a href="<c:url value='/admin/subjects/${subject.code}/delete'></c:url>"><span class="glyphicon glyphicon-remove"></span> Delete subject</a></p>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
